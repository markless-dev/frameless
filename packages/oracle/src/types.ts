...
export const ORACLE_CONTRACT_VERSION = 'frameless-equivalence-oracle/1' as const;
...
export type RunTrace = {
	contract: typeof ORACLE_CONTRACT_VERSION;
	scenario: string;
	framework: string;
 ...
 * after phase the first observation after a framework's event transaction (for
 * React 19, after `await act(async () => ...)`). The microtask and quiescence
 * phases remain additional, ordered scheduler observations.
 */
