...
export const isUpdateExpression = (value: unknown, properties?: Properties): boolean =>
	matches(value, 'UpdateExpression', properties);
...
export const isJSXFragment = (value: unknown): boolean => matches(value, 'JSXFragment');
