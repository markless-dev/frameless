...
function directiveViolations(file: string, parsed: Parsed): GateViolation[] {
	...
	for (const directive of parsed.directives) {
		...
		// planted-eighth-scenario calibration proving the assertion moves. Editing
