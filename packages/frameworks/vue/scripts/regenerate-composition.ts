...
/**
 * STEP 5, COMPOSITION - the Vue half of the third regeneration tier.
 *
 ...
 * solid. This script is the Vue lane joining that tier.
 *
 ...
 * module, and a `.vue` file declares exactly one component - the lane limit
...
export const COMPOSITION_EXTENSION = '.vue';
