...
const fixtures = [
	...
	// is a SIX-LANE APPLICATION for the same reason S15 and S16 are: THE FIXTURE
	...
	// that sequence - "the FOURTH ... after S13, S15 and S16" - counting from S13,
	// which was never first. See the S15 row above.
	//
