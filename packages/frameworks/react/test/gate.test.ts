...
describe('React dossier gate', () => {
	...
	const mutationCases = [
		...
		['computed-member setter', valid.replace('return <section>', "const key = 'run'; ({ [key]: setValue })[key](1);\n  return <section>"), 'render-phase-setter'],
		['dynamic computed-member setter', valid.replace('return <section>', "const key = items[0]; ({ [key]: setValue })[key](1);\n  return <section>"), 'render-phase-setter'],
		['computed-member setter', valid.replace('return <section>', "const key = 'run'; ({ [key]: setValue })[key](1);\n  return <section>"), 'render-phase-setter'],
		['dynamic computed-member setter', valid.replace('return <section>', 'const key = items[0]; ({ run: setValue })[key](1);\n  return <section>'), 'render-phase-setter'],
