...
describe('public React adapter entry', () => {
	...
	test('has a browser-safe import graph', async () => {
		...
		while (pending.length) {
			...
			expect(imports.filter((specifier) => specifier.startsWith('node:')), file).toEqual([]);
