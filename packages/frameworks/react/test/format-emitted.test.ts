...
// of four consecutive post-fix runs in which neither this file nor its Solid
...
// test in 602 ms (React) and 605 ms (Solid), so Windows costs 6.9-11.9x and the
// run-to-run spread on Windows alone is 1.73x.
//
