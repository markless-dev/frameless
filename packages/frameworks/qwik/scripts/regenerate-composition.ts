...
/**
 * STEP 5, COMPOSITION - the Qwik half of the third regeneration tier.
 *
 ...
 * solid. This script is the Qwik lane joining that tier.
 *
 ...
 * ONE module - and this lane can express it because a `.tsx` file holds as many
...
export const COMPOSITION_EXTENSION = '.tsx';
