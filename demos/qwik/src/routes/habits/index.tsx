...
// is a SIX-LANE APPLICATION, and the FIRST that was designed to be so rather
// than turning out that way - the position this header used to state instead
// ("the SECOND ... after S13") counted from S13, which was never first, and the
// /hn header records why. The whole app is SYNCHRONOUS DERIVED STATE, so there
// is no `Promise` or
