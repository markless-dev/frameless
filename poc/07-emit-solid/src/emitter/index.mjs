...
const VERSION = 'frameless-enriched-ir/1';
...
export function emitSolid(ir) {
  ...
  if (importNames.length) {
    ...
    imports.leadingComments = [{ type: 'CommentLine', value: ' @generated by frameless-poc-07-emit-solid; do not edit.' }];
    program.push(imports);
  } else {
    exported.leadingComments = [{ type: 'CommentLine', value: ' @generated by frameless-poc-07-emit-solid; do not edit.' }];
  }
