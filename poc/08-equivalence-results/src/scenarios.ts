...
export const scenarios: Scenario[] = [
  { id: 'S1-render-once-locals', purpose: 'render-once locals, state, derived output and callback', initialProps: { label: 'Arcade', multiplier: 3, visible: true }, actions: [{ type: 'click', target: '[data-action="increment"]' }] },
